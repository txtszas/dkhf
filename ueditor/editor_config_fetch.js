...
,toolbars:[["Bold","Italic","Underline","FontSize","FontFamily","StrikeThrough","ForeColor","JustifyLeft","JustifyCenter","JustifyRight","JustifyJustify","RemoveFormat","Indent","PastePlain","InsertImage","InsertVideo","Link","Unlink","FullScreen","Source","Undo","Redo"]]
//当鼠标放在工具栏上时显示的tooltip提示
,labelMap:{'bold':'','italic':'','underline':'','fontsize':'','fontfamily':'','strikethrough':'','forecolor':'','justifyleft':'','justifycenter':'','justifyright':'','justifyjustify':'','removeformat':'','indent':'','pasteplain':'','insertimage':'','insertvideo':'','link':'','unlink':'','fullscreen':'','source':'','undo':'','redo':''}
